...
import errorLight from '@assets/images/pages/error.svg?raw';
import errorDark from '@assets/images/pages/error-dark.svg?raw';
import useSkin from '@utils/hooks/useSkin';
import { Button } from 'antd';

const DisConnect = () => {
  const { skin } = useSkin();
  const svgContent = skin === 'dark' ? errorDark : errorLight;
  ...
  return (
    <div className='disconnect_wrapper w-full h-screen flex items-center justify-center flex-col'>
      <div className='flex flex-col justify-center items-center w-fit h-fit'>
        <p className='mb-1 text-2xl font-bold'>Network Disconnected 📡</p>
        <p className='my-2'>Oops! 😔 It seems you've lost your internet connection.</p>
        <Button
          onClick={handleReload}
          type='primary'
          className='btn-sm-block my-2'
        >
          Reload Page
        </Button>
      </div>
      <div className='flex justify-center items-end w-fit h-fit'>
        <div
          className='error_image'
          dangerouslySetInnerHTML={{ __html: svgContent }}
        />
        <StyledWrapper>
          <div className="flex items-center justify-center w-full h-fit ms-9">
                  ...
                  <div className="screen_out">
                    <div className="screen_out1">
                      <div className="screen flex flex-col items-center justify-center">
                        <span className="notfound_text">Check Your Network :(</span>
                        {/* <Button type='primary' className='mt-4'>Refresh</Button> */}
                      </div>
