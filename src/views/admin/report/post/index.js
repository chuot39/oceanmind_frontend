...
import { Card, Button, Tag, Select, DatePicker, Form } from 'antd';
import { FormattedMessage, useIntl } from 'react-intl';
import { usePostReport } from './hook';
import ReportTable from './components/ReportTable';
import ReportDetail from './components/ReportDetail';
import StatCards from './components/StatCards';
import './post-report.scss';

const { RangePicker } = DatePicker;
const { Option } = Select;

const PostReportDashboard = () => {
    const intl = useIntl();
    ...
    const { data: reportsData, isLoading: isLoadingReports } = usePostReport({
        ...filterValues,
    });
    ...
    const handleRemoveFilter = (filterKey, value) => {
        ...
        form.setFieldsValue({ [filterKey]: Array.isArray(updatedFilters[filterKey]) ? updatedFilters[filterKey] : undefined });
    ...
    return (
        <div className="post-report-dashboard min-h-screen p-4">
            <div className="mx-auto">
                <h1 className="text-3xl font-bold text_first mb-4">
                    <FormattedMessage id="admin.report.post.title" defaultMessage="Post Reports Dashboard" />
                </h1>
...
export default PostReportDashboard;