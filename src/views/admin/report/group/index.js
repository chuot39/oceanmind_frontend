...
import { useGroupReports } from './hook';
import ReportTable from './components/ReportTable';
import ReportDetail from './components/ReportDetail';
import StatCards from './components/StatCards';
import './group-report.scss';
...
const GroupReportDashboard = () => {
    ...
    const { data: reportsData, isLoading: isLoadingReports } = useGroupReports({
        ...filterValues,
    });
    ...
    return (
        <div className="group-report-dashboard min-h-screen p-4">
            <div className="mx-auto">
                <h1 className="text-3xl font-bold text_first mb-4">
                    <FormattedMessage id="admin.report.group.title" defaultMessage="Group Reports Dashboard" />
                </h1>
...
export default GroupReportDashboard;