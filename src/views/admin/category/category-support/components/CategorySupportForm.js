...
const CategorySupportForm = ({
    ...
    const title = isEdit ? 'Edit Support Category' : 'Add New Support Category';
    ...
    return (
        ...
        >
            <Form
                form={form}
                layout="vertical"
                className="category-support-form"
            >
...
export default CategorySupportForm; 