...
var BaseInput = import_react.default.forwardRef(function(props, ref) {
  ...
  var element = (0, import_react.cloneElement)(inputElement, {
    value,
    className: (0, import_classnames.default)((_props = inputElement.props) === null || _props === void 0 ? void 0 : _props.className, !hasAffix && (classNames5 === null || classNames5 === void 0 ? void 0 : classNames5.variant)) || null
  });
  ...
  if (hasAffix) {
    ...
    var affixWrapperCls = (0, import_classnames.default)(affixWrapperPrefixCls, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-disabled"), disabled), "".concat(affixWrapperPrefixCls, "-disabled"), disabled), "".concat(affixWrapperPrefixCls, "-focused"), focused), "".concat(affixWrapperPrefixCls, "-readonly"), readOnly), "".concat(affixWrapperPrefixCls, "-input-with-clear-btn"), suffix && allowClear && value), classes === null || classes === void 0 ? void 0 : classes.affixWrapper, classNames5 === null || classNames5 === void 0 ? void 0 : classNames5.affixWrapper, classNames5 === null || classNames5 === void 0 ? void 0 : classNames5.variant);
...
var TextArea = import_react3.default.forwardRef(function(_ref, ref) {
  ...
  return import_react3.default.createElement(BaseInput_default, {
    ...
    classNames: _objectSpread2(_objectSpread2({}, classNames5), {}, {
      affixWrapper: (0, import_classnames4.default)(classNames5 === null || classNames5 === void 0 ? void 0 : classNames5.affixWrapper, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-show-count"), showCount), "".concat(prefixCls, "-textarea-allow-clear"), allowClear))
    }),
    disabled,
    focused,
...
var useVariant = function(component, variant) {
  ...
  const ctxVariant = React7.useContext(VariantContext);
...
function useRemovePasswordTimeout(inputRef, triggerOnMount) {
  const removePasswordTimeoutRef = (0, import_react5.useRef)([]);
...
var Input2 = (0, import_react6.forwardRef)((props, ref) => {
  const {
  ...
  const disabled = import_react6.default.useContext(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const {
    status: contextStatus,
    hasFeedback,
    feedbackIcon
  } = (0, import_react6.useContext)(FormItemInputContext);
  const mergedStatus = getMergedStatus(contextStatus, customStatus);
  const inputHasPrefixSuffix = hasPrefixSuffix2(props) || !!hasFeedback;
  const prevHasPrefixSuffix = (0, import_react6.useRef)(inputHasPrefixSuffix);
  if (true) {
  ...
  const suffixNode = (hasFeedback || suffix) && import_react6.default.createElement(import_react6.default.Fragment, null, suffix, hasFeedback && feedbackIcon);
  ...
  return wrapSharedCSSVar(wrapCSSVar(import_react6.default.createElement(es_default2, Object.assign({
    ...
    className: (0, import_classnames6.default)(className, rootClassName, cssVarCls, rootCls, compactItemClassnames, contextClassName),
    onChange: handleChange,
    addonBefore: addonBefore && import_react6.default.createElement(ContextIsolator_default, {
      form: true,
      space: true
    }, addonBefore),
    addonAfter: addonAfter && import_react6.default.createElement(ContextIsolator_default, {
      form: true,
      space: true
    }, addonAfter),
...
var TextArea2 = (0, import_react7.forwardRef)((props, ref) => {
  var _a;
  const {
    prefixCls: customizePrefixCls,
    bordered = true,
    ...
    onMouseDown,
    onResize
  } = props, rest = __rest2(props, ["prefixCls", "bordered", "size", "disabled", "status", "allowClear", "classNames", "rootClassName", "className", "style", "styles", "variant", "showCount", "onMouseDown", "onResize"]);
  if (true) {
    const {
      deprecated
  ...
  const disabled = React9.useContext(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const {
    status: contextStatus,
    hasFeedback,
    feedbackIcon
  } = React9.useContext(FormItemInputContext);
  const mergedStatus = getMergedStatus(contextStatus, customStatus);
  ...
  const mergedAllowClear = getAllowClear_default(allowClear !== null && allowClear !== void 0 ? allowClear : contextAllowClear);
  const [isMouseDown, setIsMouseDown] = React9.useState(false);
  const [resizeDirty, setResizeDirty] = React9.useState(false);
  ...
  return wrapSharedCSSVar(wrapCSSVar(React9.createElement(es_default3, Object.assign({
    autoComplete: contextAutoComplete
  }, rest, {
    style: Object.assign(Object.assign({}, contextStyle), style),
    styles: Object.assign(Object.assign({}, contextStyles), styles),
    ...
    prefixCls,
    suffix: hasFeedback && React9.createElement("span", {
...
//# sourceMappingURL=chunk-PRLW32QB.js.map
