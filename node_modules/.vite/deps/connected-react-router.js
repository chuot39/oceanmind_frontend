...
var createConnectedRouter = function createConnectedRouter2(structure2) {
  ...
  ConnectedRouter2.propTypes = {
    ...
    history: import_prop_types.default.shape({
      action: import_prop_types.default.string.isRequired,
      listen: import_prop_types.default.func.isRequired,
      location: import_prop_types.default.object.isRequired,
      push: import_prop_types.default.func.isRequired
    }).isRequired,
    ...
    onLocationChanged: import_prop_types.default.func.isRequired,
    noInitialPop: import_prop_types.default.bool,
    noTimeTravelDebugging: import_prop_types.default.bool,
    stateCompareFunction: import_prop_types.default.func,
    omitRouter: import_prop_types.default.bool
  };
  ...
  var ConnectedRouterWithContext = function ConnectedRouterWithContext2(props) {
    ...
    return import_react.default.createElement(Context.Consumer, null, function(_ref) {
      var store = _ref.store;
      return import_react.default.createElement(ConnectedRouter2, _extends({
        store
      }, props));
    });
  };
